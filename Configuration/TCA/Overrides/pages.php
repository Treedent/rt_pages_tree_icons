...
$pageIcons = [
	...
	[$langFile . 'pageb-s',             'pageb-s',              'apps-pagetree-page-black-s'],
    [$langFile . 'pageblt',             'pageblt',              'apps-pagetree-page-blue-light'],
	[$langFile . 'pageblt-s',           'pageblt-s',            'apps-pagetree-page-blue-light-s'],
    [$langFile . 'pagebl',              'pagebl',               'apps-pagetree-page-blue'],
	[$langFile . 'pagebl-s',            'pagebl-s',             'apps-pagetree-page-blue-s'],
	[$langFile . 'pageblf',             'pageblf',              'apps-pagetree-page-blue-fluo'],
	[$langFile . 'pageblf-s',           'pageblf-s',            'apps-pagetree-page-blue-fluo-s'],
    [$langFile . 'pagegb',              'pagegb',               'apps-pagetree-page-gray-brighter'],
	[$langFile . 'pagegb-s',            'pagegb-s',             'apps-pagetree-page-gray-brighter-s'],
    [$langFile . 'pagegd',              'pagegd',               'apps-pagetree-page-gray-dark'],
	[$langFile . 'pagegd-s',            'pagegd-s',             'apps-pagetree-page-gray-dark-s'],
	[$langFile . 'pagegl',              'pagegl',               'apps-pagetree-page-gray-light'],
	[$langFile . 'pagegl-s',            'pagegl-s',             'apps-pagetree-page-gray-light-s'],
    [$langFile . 'pageg',               'pageg',                'apps-pagetree-page-gray'],
	[$langFile . 'pageg-s',             'pageg-s',              'apps-pagetree-page-gray-s'],
    [$langFile . 'pagegrl',             'pagegrl',              'apps-pagetree-page-green-light'],
	[$langFile . 'pagegrl-s',           'pagegrl-s',            'apps-pagetree-page-green-light-s'],
    [$langFile . 'pagegr',              'pagegr',               'apps-pagetree-page-green'],
	[$langFile . 'pagegr-s',            'pagegr-s',             'apps-pagetree-page-green-s'],
	[$langFile . 'pagegrf',             'pagegrf',              'apps-pagetree-page-green-fluo'],
	[$langFile . 'pagegrf-s',           'pagegrf-s',            'apps-pagetree-page-green-fluo-s'],
    [$langFile . 'pageo',               'pageo',                'apps-pagetree-page-orange'],
	[$langFile . 'pageo-s',             'pageo-s',              'apps-pagetree-page-orange-s'],
	[$langFile . 'pageof',              'pageof',               'apps-pagetree-page-orange-fluo'],
	[$langFile . 'pageof-s',            'pageof-s',             'apps-pagetree-page-orange-fluo-s'],
    [$langFile . 'pagep',               'pagep',                'apps-pagetree-page-purple'],
	[$langFile . 'pagep-s',             'pagep-s',              'apps-pagetree-page-purple-s'],
	[$langFile . 'pagerl',              'pagerl',               'apps-pagetree-page-red-light'],
	[$langFile . 'pagerl-s',            'pagerl-s',             'apps-pagetree-page-red-light-s'],
    [$langFile . 'pager',               'pager',                'apps-pagetree-page-red'],
	[$langFile . 'pager-s',             'pager-s',              'apps-pagetree-page-red-s'],
	[$langFile . 'pagerf',              'pagerf',               'apps-pagetree-page-red-fluo'],
	[$langFile . 'pagerf-s',            'pagerf-s',             'apps-pagetree-page-red-fluo-s'],
	[$langFile . 'pagew',               'pagew',                'apps-pagetree-page-white'],
	[$langFile . 'pagew-s',             'pagew-s',              'apps-pagetree-page-white-s'],
    [$langFile . 'pageyl',              'pageyl',               'apps-pagetree-page-yellow-light'],
	[$langFile . 'pageyl-s',            'pageyl-s',             'apps-pagetree-page-yellow-light-s'],
    [$langFile . 'pagey',               'pagey',                'apps-pagetree-page-yellow'],
	[$langFile . 'pagey-s',             'pagey-s',              'apps-pagetree-page-yellow-s'],
	[$langFile . 'pageyf',              'pageyf',               'apps-pagetree-page-yellow-fluo'],
	[$langFile . 'pageyf-s',            'pageyf-s',             'apps-pagetree-page-yellow-fluo-s'],
	[$langFile . 'pagegdpr',            'pagegdpr',             'apps-pagetree-page-gdpr'],
	[$langFile . 'pagegdpr-s',          'pagegdpr-s',           'apps-pagetree-page-gdpr-s'],
	...
	[$langFile .'appdev',               'appdev',               'apps-pagetree-dev'],
	[$langFile .'app404',               'app404',               'apps-pagetree-error-404'],
	...
	[$langFile .'apppresentation',      'apppresentation',      'apps-pagetree-presentation'],
	...
	[$langFile .'symbshopcart',         'symbshopcart',         'apps-pagetree-shopping-cart'],
    [$langFile .'symbuniversity',       'symbuniversity',       'apps-pagetree-university'],
	[$langFile .'symbbrainstorm',       'symbbrainstorm',       'apps-pagetree-brainstorm'],
    [$langFile .'symbfaq',              'symbfaq',              'apps-pagetree-faq'],
	[$langFile .'symbtestimonial',      'symbtestimonial',      'apps-pagetree-testimonial'],
	[$langFile .'symbannouncement',     'symbannouncement',     'apps-pagetree-announcement'],
    [$langFile .'apprssb',              'apprssb',              'apps-pagetree-rss-black'],
    [$langFile .'apprsso',              'apprsso',              'apps-pagetree-rss-orange'],
	[$langFile .'symbchart',            'symbchart',            'apps-pagetree-chart'],
	...
	['Vimeo',                           'appvimeo',             'apps-pagetree-social-vimeo'],
	['Youtube',                         'appyoutube',           'apps-pagetree-social-youtube'],
	['Instagram',                       'appinstagram',         'apps-pagetree-social-instagram'],
