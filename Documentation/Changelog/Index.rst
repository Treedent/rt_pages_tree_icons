...
- V5.0.0 for TYPO3 V11.
    - Added Support for TYPO3 V11LTS AND V12.
    - Removed support for TYPO3 V9LTS AND V10LTS, use version 4.1.2 instead.
    - Documentation remastered for sphinx engine.



- V4.1.2 for TYPO3 V8, V9 & V10.
    - Added Support for TYPO3 V10 LTS.
    - Removed support for TYPO3 V7 LTS, use version 3.5.2 instead.



- V3.5.2 for TYPO3 V7, V8 & V9.
