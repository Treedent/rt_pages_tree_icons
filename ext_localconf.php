...
$boot = function () {
    ...
    if (TYPO3_MODE === 'BE') {
        ...
        $icons = [
            ...
            'apps-pagetree-page-black-s'					=>			'pagetree-page/pagetree-page-black-shortcut.svg',
            'apps-pagetree-page-blue-light'					=>			'pagetree-page/pagetree-page-blue-light.svg',
            'apps-pagetree-page-blue-light-s'				=>			'pagetree-page/pagetree-page-blue-light-shortcut.svg',
            'apps-pagetree-page-blue'						=>			'pagetree-page/pagetree-page-blue.svg',
            'apps-pagetree-page-blue-s'						=>			'pagetree-page/pagetree-page-blue-shortcut.svg',
            'apps-pagetree-page-blue-fluo'					=>			'pagetree-page/pagetree-page-blue-fluo.svg',
            'apps-pagetree-page-blue-fluo-s'				=>			'pagetree-page/pagetree-page-blue-fluo-shortcut.svg',
            'apps-pagetree-page-gray-brighter'				=>			'pagetree-page/pagetree-page-gray-brighter.svg',
            'apps-pagetree-page-gray-brighter-s'			=>			'pagetree-page/pagetree-page-gray-brighter-shortcut.svg',
            'apps-pagetree-page-gray-dark'					=>			'pagetree-page/pagetree-page-gray-dark.svg',
            'apps-pagetree-page-gray-dark-s'				=>			'pagetree-page/pagetree-page-gray-dark-shortcut.svg',
            'apps-pagetree-page-gray-light'					=>			'pagetree-page/pagetree-page-gray-light.svg',
            'apps-pagetree-page-gray-light-s'				=>			'pagetree-page/pagetree-page-gray-light-shortcut.svg',
            'apps-pagetree-page-gray'						=>			'pagetree-page/pagetree-page-gray.svg',
            'apps-pagetree-page-gray-s'						=>			'pagetree-page/pagetree-page-gray-shortcut.svg',
            'apps-pagetree-page-green-light'				=>			'pagetree-page/pagetree-page-green-light.svg',
            'apps-pagetree-page-green-light-s'				=>			'pagetree-page/pagetree-page-green-light-shortcut.svg',
            'apps-pagetree-page-green'						=>			'pagetree-page/pagetree-page-green.svg',
            'apps-pagetree-page-green-s'					=>			'pagetree-page/pagetree-page-green-shortcut.svg',
            'apps-pagetree-page-green-fluo'					=>			'pagetree-page/pagetree-page-green-fluo.svg',
            'apps-pagetree-page-green-fluo-s'       		=>			'pagetree-page/pagetree-page-green-fluo-shortcut.svg',
            'apps-pagetree-page-orange'						=>			'pagetree-page/pagetree-page-orange.svg',
            'apps-pagetree-page-orange-s'					=>			'pagetree-page/pagetree-page-orange-shortcut.svg',
            'apps-pagetree-page-orange-fluo'				=>			'pagetree-page/pagetree-page-orange-fluo.svg',
            'apps-pagetree-page-orange-fluo-s'				=>			'pagetree-page/pagetree-page-orange-fluo-shortcut.svg',
            'apps-pagetree-page-purple'						=>			'pagetree-page/pagetree-page-purple.svg',
            'apps-pagetree-page-purple-s'					=>			'pagetree-page/pagetree-page-purple-shortcut.svg',
            'apps-pagetree-page-red-light'					=>			'pagetree-page/pagetree-page-red-light.svg',
            'apps-pagetree-page-red-light-s'				=>			'pagetree-page/pagetree-page-red-light-shortcut.svg',
            'apps-pagetree-page-red'						=>			'pagetree-page/pagetree-page-red.svg',
            'apps-pagetree-page-red-s'						=>			'pagetree-page/pagetree-page-red-shortcut.svg',
            'apps-pagetree-page-red-fluo'					=>			'pagetree-page/pagetree-page-red-fluo.svg',
            'apps-pagetree-page-red-fluo-s'					=>			'pagetree-page/pagetree-page-red-fluo-shortcut.svg',
            'apps-pagetree-page-white'						=>			'pagetree-page/pagetree-page-white.svg',
            'apps-pagetree-page-white-s'					=>			'pagetree-page/pagetree-page-white-shortcut.svg',
            'apps-pagetree-page-yellow-light'				=>			'pagetree-page/pagetree-page-yellow-light.svg',
            'apps-pagetree-page-yellow-light-s'				=>			'pagetree-page/pagetree-page-yellow-light-shortcut.svg',
            'apps-pagetree-page-yellow'						=>			'pagetree-page/pagetree-page-yellow.svg',
            'apps-pagetree-page-yellow-s'					=>			'pagetree-page/pagetree-page-yellow-shortcut.svg',
            'apps-pagetree-page-yellow-fluo'				=>			'pagetree-page/pagetree-page-yellow-fluo.svg',
            'apps-pagetree-page-yellow-fluo-s'				=>			'pagetree-page/pagetree-page-yellow-fluo-shortcut.svg',
	        'apps-pagetree-page-gdpr'                       =>          'pagetree-page/pagetree-page-gdpr.svg',
            'apps-pagetree-page-gdpr-s'                     =>          'pagetree-page/pagetree-page-gdpr-shortcut.svg',
            ...
            'apps-pagetree-earth-s'							=>			'symbols/earth-shortcut.svg',
